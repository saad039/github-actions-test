...
print(
    f'The name of function is The name of function is The name of function is The name of function is The name of function is The name of function is: {foo.__name__}')
